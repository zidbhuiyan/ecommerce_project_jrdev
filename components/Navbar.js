            ...
            <div className="max-w-[1240px] m-auto flex justify-between items-center p-4">
              <Link href="/admin">
                <div className="text-2xl flex p-4">
                  <h1 className="p-1 text-[#6765f0]">E</h1>
              ...
              <div className="block sm:hidden z-10">
                {nav ? (
                  <AiOutlineClose onClick={() => setNav(false)} size={30} />
                ) : (
              ...
              <div
                className={
                  nav
                    ? "sm:hidden absolute top-0 left-0 bottom-0 right-0 text-center flex justify-center items-center w-full h-screen bg-white ease-in"
                    : "hidden"
                }
              >
                <ul>
          ...
          <div className="fixed top-0 left-0 w-full z-10 ease-in bg-[#fefeff]">
            <div className="max-w-[1240px] m-auto flex justify-between items-center p-4">
              ...
              >
                <ul>
                  <li className="p-4 text-3xl hover:text-blue-600">
                    <Link href="/product" onClick={() => setNav(false)}>
                      Product
                    </Link>
                  </li>
                  <li className="p-4 text-3xl hover:text-blue-600">
